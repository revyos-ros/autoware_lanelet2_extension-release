...
The packages in the `autoware_lanelet2_extension` repository were released into the `humble` distro by running `/home/z572/gits/revyos-ros/venv/bin/bloom-release -r humble autoware_lanelet2_extension --override-release-repository-push-url git@github.com:revyos-ros/autoware_lanelet2_extension-release.git` on `Tue, 17 Jun 2025 04:08:57 -0000`
...
- release repository: https://github.com/revyos-ros/autoware_lanelet2_extension-release.git
...
The packages in the `autoware_lanelet2_extension` repository were released into the `jazzy` distro by running `/home/z572/gits/revyos-ros/venv/bin/bloom-release -r jazzy autoware_lanelet2_extension --override-release-repository-push-url git@github.com:revyos-ros/autoware_lanelet2_extension-release.git` on `Tue, 10 Jun 2025 18:15:52 -0000`
...
The packages in the `autoware_lanelet2_extension` repository were released into the `jazzy` distro by running `/home/z572/gits/revyos-ros/venv2/bin/bloom-release -r jazzy autoware_lanelet2_extension --override-release-repository-push-url git@github.com:revyos-ros/autoware_lanelet2_extension-release.git` on `Thu, 19 Dec 2024 05:33:49 -0000`
...
The packages in the `autoware_lanelet2_extension` repository were released into the `humble` distro by running `/home/z572/gits/revyos-ros/venv2/bin/bloom-release -r humble autoware_lanelet2_extension --override-release-repository-push-url git@github.com:revyos-ros/autoware_lanelet2_extension-release.git` on `Thu, 12 Dec 2024 12:18:43 -0000`
...
## autoware_lanelet2_extension (humble) - 0.6.1-1

The packages in the `autoware_lanelet2_extension` repository were released into the `humble` distro by running `/home/z572/gits/revyos-ros/venv2/bin/bloom-release -r humble autoware_lanelet2_extension --override-release-repository-push-url git@github.com:revyos-ros/autoware_lanelet2_extension-release.git` on `Tue, 29 Oct 2024 03:27:07 -0000`
